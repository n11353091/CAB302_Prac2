...
public class Main {
    ...
    public static void onLogIn() {
        ...
        ToDoList newUser = new ToDoList(user);
        newUser.run();
    }
    ...
    public static void onSignUp() {
        ...
        if (user != null){
            String string = String.format("User %s has been created successfully!", user.getUsername());
            System.out.println(string);
        }
        else {
            String string = "The username is already taken!";
            System.out.println(string);
        }
    }
